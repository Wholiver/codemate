...
<p align="center"><strong>快速浏览：</strong> <a href="#30-秒价值">30 秒价值</a> · <a href="#install-cli">安装</a> · <a href="#架构总览">架构</a> · <a href="#核心能力">核心能力</a> · <a href="#对比">对比</a></p>
...
> [!IMPORTANT]
> 如果你要直接运行 `codemate` 命令，请安装 CLI 包 `codemate-ai`。
...
JSR 上的 `@codemate/codemate` 是用于集成的 SDK 包，不会安装 `codemate` CLI 命令。

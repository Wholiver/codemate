...
<p align="center"><strong>快速浏览：</strong> <a href="#30-秒价值">30 秒价值</a> · <a href="#install-jsr-sdk">安装</a> · <a href="#架构总览">架构</a> · <a href="#核心能力">核心能力</a> · <a href="#对比">对比</a></p>
...
> [!IMPORTANT]
> `@codemate/codemate` 是 SDK 包，不会安装全局 `codemate` 可执行命令。

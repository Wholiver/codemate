export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Codemate",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Codemate. ¿Quieres instalarla y reiniciar?",

...
import { base64Encode } from "@codemate-ai/core/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@codemate-ai/ui/resize-handle"
...
import { Session, type Message } from "@codemate-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@codemate-ai/ui/toast"
...
import { retry } from "@codemate-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@codemate-ai/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://codemate.ai/desktop-feedback")}
      renderPanel={() =>

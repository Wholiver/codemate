import { AppIcon } from "@codemate-ai/ui/app-icon"
...
import { Keybind } from "@codemate-ai/ui/keybind"
...
export function SessionHeader() {
  ...
  const isDesktopBeta = platform.platform === "desktop" && import.meta.env.VITE_codemate_CHANNEL === "beta"
  ...
  onMount(() => {
    setCenterMount(document.getElementById("codemate-titlebar-center"))
    setRightMount(document.getElementById("codemate-titlebar-right"))
  })

...
beforeAll(async () => {
  ...
  mock.module("@codemate-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@codemate-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@codemate-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@codemate-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

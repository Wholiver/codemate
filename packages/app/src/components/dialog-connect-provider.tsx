import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@codemate-ai/sdk/v2/client"
import { Button } from "@codemate-ai/ui/button"
import { useDialog } from "@codemate-ai/ui/context/dialog"
import { Dialog } from "@codemate-ai/ui/dialog"
import { Icon } from "@codemate-ai/ui/icon"
import { IconButton } from "@codemate-ai/ui/icon-button"
import { List, type ListRef } from "@codemate-ai/ui/list"
import { ProviderIcon } from "@codemate-ai/ui/provider-icon"
import { Spinner } from "@codemate-ai/ui/spinner"
import { TextField } from "@codemate-ai/ui/text-field"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "codemate"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.codemateZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.codemateZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.codemateZen.visit.prefix")}
                <Link href="https://codemate.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.codemateZen.visit.link")}
                </Link>
                {language.t("provider.connect.codemateZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>

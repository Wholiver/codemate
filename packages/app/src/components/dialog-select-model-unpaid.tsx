              ...
              >
                {(i) => (
                  <div class="w-full flex items-center gap-x-3">
                    ...
                    <span>{i.name}</span>
                    <Show when={i.id === "codemate"}>
                      <div class="text-14-regular text-text-weak">{language.t("dialog.provider.codemate.tagline")}</div>
                    </Show>
                    <Show when={i.id === "codemate"}>
                      <Tag>{language.t("dialog.provider.tag.recommended")}</Tag>
                    </Show>
                    <Show when={i.id === "codemate-go"}>
                      <>
                        <div class="text-14-regular text-text-weak">
                          {language.t("dialog.provider.codemateGo.tagline")}
                        </div>
                        <Tag>{language.t("dialog.provider.tag.recommended")}</Tag>
                      </>
                    </Show>

...
export const dict = {
  ...
  "dialog.provider.codemate.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.codemate.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.codemateGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Codemate tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Codemate'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.codemateZen.line1":
    "Codemate Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.codemateZen.visit.prefix": "",
  "provider.connect.codemateZen.visit.link": "codemate.ai/zen",
  "provider.connect.codemateZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Codemate'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Codemate'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler codemate.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Codemate sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Codemate'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Codemate ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (codemate.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Codemate henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Codemate ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Codemate Masaüstü",
  ...
  "settings.desktop.wsl.description": "Codemate sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Codemate'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Codemate'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Codemate'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Codemate'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Codemate başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Codemate'un en son sürümünü kullanıyorsunuz.",

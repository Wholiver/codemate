export const dict = {
  ...
  "dialog.provider.codemate.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.codemate.tagline": "Modèles optimisés et fiables",
  "dialog.provider.codemateGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par codemate",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans codemate.",
  ...
  "provider.connect.codemateZen.line1":
    "codemate Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  "provider.connect.codemateZen.line2":
    "Avec une seule clé API, vous aurez accès à des modèles tels que Claude, GPT, Gemini, GLM et plus encore.",
  "provider.connect.codemateZen.visit.prefix": "Visitez ",
  "provider.connect.codemateZen.visit.link": "codemate.ai/zen",
  "provider.connect.codemateZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans codemate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans codemate.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans codemate.json",
  ...
  "dialog.server.description": "Changez le serveur codemate auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'codemate ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe codemate",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (codemate.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'codemate ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "codemate inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "codemate Desktop",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur codemate dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour codemate",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'codemate sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si codemate suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'codemate.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'codemate",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'codemate.",

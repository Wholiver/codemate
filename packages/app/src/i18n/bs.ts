export const dict = {
  ...
  "dialog.provider.codemate.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.codemate.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.codemateGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Codemate",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Codemate-u.",
  ...
  "provider.connect.codemateZen.line1":
    "Codemate Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.codemateZen.visit.prefix": "Posjeti ",
  "provider.connect.codemateZen.visit.link": "codemate.ai/zen",
  "provider.connect.codemateZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Codemate-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Codemate-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u codemate.json",
  ...
  "dialog.server.description": "Promijeni na koji se Codemate server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Codemate-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Codemate timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (codemate.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Codemate još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Codemate uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Codemate server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Codemate-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Codemate izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Codemate prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Codemate-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Codemate pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Codemate-a.",

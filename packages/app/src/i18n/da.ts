export const dict = {
  ...
  "dialog.provider.codemate.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.codemate.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.codemateGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af codemate",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i codemate.",
  ...
  "provider.connect.codemateZen.line1":
    "codemate Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.codemateZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.codemateZen.visit.prefix": "Besøg ",
  "provider.connect.codemateZen.visit.link": "codemate.ai/zen",
  "provider.connect.codemateZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i codemate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i codemate.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i codemate.json",
  ...
  "dialog.server.description": "Skift hvilken codemate-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af codemate ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til codemate-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (codemate.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, codemate understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "codemate inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør codemate-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for codemate",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan codemate ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om codemate følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan codemate er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når codemate starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af codemate.",

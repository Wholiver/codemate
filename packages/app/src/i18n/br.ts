export const dict = {
  ...
  "dialog.provider.codemate.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.codemate.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.codemateGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Codemate",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Codemate.",
  ...
  "provider.connect.codemateZen.line1":
    "Codemate Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.codemateZen.visit.prefix": "Visite ",
  "provider.connect.codemateZen.visit.link": "codemate.ai/zen",
  "provider.connect.codemateZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Codemate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Codemate.",
  ...
  "dialog.plugins.empty": "Plugins configurados em codemate.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Codemate este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Codemate ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Codemate",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (codemate.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Codemate ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Codemate inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Codemate dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Codemate",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Codemate aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Codemate segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Codemate é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Codemate iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Codemate.",

export const dict = {
  ...
  "dialog.provider.codemate.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.codemate.tagline": "Modelos optimizados y fiables",
  "dialog.provider.codemateGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Codemate",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Codemate.",
  ...
  "provider.connect.codemateZen.line1":
    "Codemate Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.codemateZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.codemateZen.visit.prefix": "Visita ",
  "provider.connect.codemateZen.visit.link": "codemate.ai/zen",
  "provider.connect.codemateZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Codemate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Codemate.",
  ...
  "dialog.plugins.empty": "Plugins configurados en codemate.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Codemate se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Codemate ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Codemate",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (codemate.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Codemate no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Codemate incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Codemate dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Codemate",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Codemate en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Codemate sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Codemate.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Codemate",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Codemate.",

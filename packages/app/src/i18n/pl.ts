export const dict = {
  ...
  "dialog.provider.codemate.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.codemate.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.codemateGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Codemate",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Codemate.",
  ...
  "provider.connect.codemateZen.line1":
    "Codemate Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.codemateZen.visit.prefix": "Odwiedź ",
  "provider.connect.codemateZen.visit.link": "codemate.ai/zen",
  "provider.connect.codemateZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Codemate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Codemate.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w codemate.json",
  ...
  "dialog.server.description": "Przełącz serwer Codemate, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Codemate ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Codemate",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (codemate.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Codemate zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Codemate",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Codemate na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Codemate ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Codemate.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Codemate",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Codemate.",

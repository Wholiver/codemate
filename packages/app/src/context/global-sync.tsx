...
export const loadMcpQuery = (directory: string, sdk?: CodemateClient) =>
  queryOptions({
    queryKey: [directory, "mcp"],
    queryFn: sdk ? () => sdk.mcp.status().then((r) => r.data ?? {}) : skipToken,
  })

export const loadLspQuery = (directory: string, sdk?: CodemateClient) =>
  queryOptions({
...
function createGlobalSync() {
  ...
  const sdkCache = new Map<string, CodemateClient>()

...
Erstellen Sie `.codemate/commands/test.md`:

```md title=".codemate/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die codemate-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem codemate [config](/docs/config):

```json title="codemate.jsonc" {4-12}
{
...
- Global: `~/.config/codemate/commands/`
- Pro Projekt: `.codemate/commands/`

```markdown title="~/.config/codemate/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".codemate/commands/component.md"
---
...
```md title=".codemate/commands/create-file.md"
---
...
```md title=".codemate/commands/analyze-coverage.md"
---
...
```md title=".codemate/commands/review-changes.md"
---
...
```md title=".codemate/commands/review-component.md"
---
...
codemate enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).

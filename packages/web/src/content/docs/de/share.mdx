---
title: Teilen
description: Teile codemate-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu codemate-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht codemate Folgendes:
...
codemate hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt codemate den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`codemate.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du codemate in deiner Organisation einsetzt.

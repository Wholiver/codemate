---
title: TUI
description: Arbeite mit Codemate in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Codemate bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Codemate die TUI im aktuellen Verzeichnis.
...
In der Codemate-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu Codemate hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet Codemate. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `codemate.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `CODEMATE_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.

---
title: Zen
description: Kuratierte Modellliste direkt von Codemate.
---
...
Codemate Zen ist eine Liste von getesteten und verifizierten Modellen, die vom Codemate-Team bereitgestellt wird.

:::note
Codemate Zen befindet sich derzeit in der Beta.
:::

Zen funktioniert wie jeder andere Provider in Codemate. Du meldest dich bei Codemate Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Codemate zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit Codemate funktionieren.
:::
...
Codemate Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

Codemate Zen funktioniert wie jeder andere Provider in Codemate.

1. Du meldest dich bei **<a href={console}>Codemate Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst Codemate Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Codemate-Konfiguration verwendet das Format `codemate/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `codemate/gpt-5.5` in deiner Konfiguration verwenden.
...
- MiniMax M2.5 Free ist für begrenzte Zeit auf Codemate verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Ling 2.6 Flash Free ist für begrenzte Zeit auf Codemate verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Hy3 Preview Flash Free ist für begrenzte Zeit auf Codemate verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Super Free ist für begrenzte Zeit auf Codemate verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Codemate verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben Codemate Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit Codemate auch jeden anderen Provider zu verwenden.

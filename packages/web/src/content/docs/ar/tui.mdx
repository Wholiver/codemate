---
title: TUI
description: استخدام واجهة المستخدم TUI في Codemate.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Codemate واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Codemate إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Codemate في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Codemate. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Codemate. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات Codemate.
...
استخدم `CODEMATE_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.

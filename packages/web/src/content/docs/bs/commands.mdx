...
Kreiraj `.codemate/commands/test.md`:
...
Možete dodati prilagođene komande kroz codemate konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom codemate [config](/docs/config):
...
- Globalno: `~/.config/codemate/commands/`
- Po projektu: `.codemate/commands/`
...
codemate uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note

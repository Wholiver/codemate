---
title: TUI
description: Korištenje korisničkog interfejsa Codemate terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Codemate pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Codemate pokreće TUI za trenutni direktorij.
...
Kada koristite Codemate TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Codemate. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Codemate. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `codemate.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `CODEMATE_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.

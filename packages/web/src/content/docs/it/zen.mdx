---
title: Zen
description: Lista curata di modelli fornita da Codemate.
---
...
Codemate Zen è un elenco di modelli testati e verificati forniti dal team di Codemate.

:::note
Codemate Zen è attualmente in beta.
:::

Zen funziona come qualsiasi altro provider in Codemate. Accedi a Codemate Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Codemate.
:::
...
Codemate Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

Codemate Zen funziona come qualsiasi altro provider in Codemate.

1. Accedi a **<a href={console}>Codemate Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Codemate Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di Codemate
usa il formato `codemate/<model-id>`. Per esempio, per GPT 5.5, useresti
`codemate/gpt-5.5` nella tua config.
...
- MiniMax M2.5 Free è disponibile su Codemate per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Ling 2.6 Flash Free è disponibile su Codemate per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Hy3 Preview Flash Free è disponibile su Codemate per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Super Free è disponibile su Codemate per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su Codemate per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato Codemate Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con Codemate.

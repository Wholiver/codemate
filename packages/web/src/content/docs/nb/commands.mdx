...
Opprett `.codemate/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom codemate-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i codemate [config](/docs/config):
...
- Per prosjekt: `.codemate/commands/`
...
codemate inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).

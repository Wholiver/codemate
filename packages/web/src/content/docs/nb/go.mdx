...
Codemate Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

:::note
Codemate Go er for øyeblikket i beta.
:::

Go fungerer som enhver annen leverandør i Codemate. Du abonnerer på Codemate Go og
...
Codemate Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

Codemate Go fungerer som enhver annen leverandør i Codemate.

1. Du logger inn på **<a href={console}>Codemate Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `Codemate Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på Codemate Go.
:::
...
Codemate Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din Codemate-konfigurasjon
bruker formatet `codemate-go/<model-id>`. For eksempel, for Kimi K2.6, vil du
bruke `codemate-go/kimi-k2.6` i konfigurasjonen din.
...
Vi opprettet Codemate Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med Codemate også.

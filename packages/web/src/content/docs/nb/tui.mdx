---
title: TUI
description: Bruke codemate-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Codemate gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Codemate starter TUI for gjeldende katalog.
...
Når du bruker Codemate TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Codemate. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Codemate. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `codemate.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `CODEMATE_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.

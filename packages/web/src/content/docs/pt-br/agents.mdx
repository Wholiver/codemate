...
codemate vem com dois subagentes integrados, **General** e **Explore**. Vamos ver isso abaixo.

---

## Integrados

codemate vem com dois agentes primários integrados e dois subagentes integrados.

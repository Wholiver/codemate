---
title: TUI
description: Usando a interface de usuário de terminal codemate.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O codemate fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar codemate inicia o TUI para o diretório atual.
...
Ao usar o TUI do codemate, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao codemate. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do codemate. _Aliases_: `/quit`, `/q`
...
Isso é separado do `codemate.json`, que configura o comportamento do servidor/runtime.
...
Use `codemate_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.

...
Brug den til at bygge integrasjoner og kontrollere codemate programmatisk.
...
Opret en forekomst av codemate:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `codemate.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av codemate, kan du oprete en klientforekomst for at koble til den:

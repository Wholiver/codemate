---
title: LSP-servere
description: codemate integreres med dine LSP-servere.
---

codemate integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

codemate leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `codemate_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når codemate åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din codemate-konfiguration.

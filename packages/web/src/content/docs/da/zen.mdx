---
title: Zen
description: Udvalgt liste over modeller leveret af Codemate.
---
...
Codemate Zen er en liste over testede og verificerede modeller leveret af Codemate-teamet.

:::note
Codemate Zen er i øjeblikket i beta.
:::

Zen fungerer som enhver anden udbyder i Codemate. Du logger ind på Codemate Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med Codemate.
:::
...
Codemate Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Codemate Zen fungerer som enhver anden udbyder i Codemate.

1. Du logger ind på **<a href={console}>Codemate Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger Codemate Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din Codemate-konfiguration
bruger formatet `codemate/<model-id>`. For eksempel ville du for GPT 5.5
bruge `codemate/gpt-5.5` i din konfiguration.
...
- MiniMax M2.5 Free er tilgængelig på Codemate i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Ling 2.6 Flash Free er tilgængelig på Codemate i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Hy3 Preview Free er tilgængelig på Codemate i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Super Free er tilgængelig på Codemate i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på Codemate i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med Codemate også.

...
Her er alle de innebygde verktøyene som er tilgængelige i codemate.
...
:::note
Dette verktøyet er bare tilgængelig når `codemate_EXPERIMENTAL_LSP_TOOL=true` (eller `codemate_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger codemate-leverandøren eller når miljøvariabelen `codemate_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).

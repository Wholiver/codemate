---
title: TUI
description: Brug af codemate-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

codemate giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre codemate starter TUI for den nuværende mappe.
...
Når du bruger codemate TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til codemate. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut codemate. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `codemate.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `codemate_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.

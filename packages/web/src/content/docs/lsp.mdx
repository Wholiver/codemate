...
Codemate integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.
...
You can customize LSP servers through the `lsp` section in your codemate config.

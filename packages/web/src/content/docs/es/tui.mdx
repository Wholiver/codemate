---
title: TUI
description: Usando la interfaz de usuario del terminal codemate.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

codemate proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar codemate se inicia TUI para el directorio actual.
...
Cuando utilice codemate TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a codemate. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de codemate. _Alias_: `/quit`, `/q`
...
Esto es independiente de `codemate.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `codemate_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.

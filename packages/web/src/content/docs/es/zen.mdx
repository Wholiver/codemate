---
title: Zen
description: Lista seleccionada de modelos proporcionada por Codemate.
---
...
Codemate Zen es una lista de modelos probados y verificados proporcionada por el equipo de Codemate.

:::note
Codemate Zen está actualmente en beta.
:::

Zen funciona como cualquier otro proveedor en Codemate. Inicias sesión en Codemate Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Codemate.
:::
...
Codemate Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

Codemate Zen funciona como cualquier otro proveedor en Codemate.

1. Inicias sesión en **<a href={console}>Codemate Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas Codemate Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de Codemate
usa el formato `codemate/<model-id>`. Por ejemplo, para GPT 5.5, usarías
`codemate/gpt-5.5` en tu configuración.
...
- MiniMax M2.5 Free está disponible en Codemate por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Ling 2.6 Flash Free está disponible en Codemate por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Hy3 Preview Flash Free está disponible en Codemate por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Super Free está disponible en Codemate por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en Codemate por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con Codemate.

...
Crear `.codemate/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Codemate o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Codemate [config](/docs/config):
...
- Por proyecto: `.codemate/commands/`
...
codemate incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).

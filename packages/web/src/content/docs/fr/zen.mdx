...
| Ring 2.6 1T           | ring-2.6-1t-free      | `https://codemate.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
- Ring 2.6 1T Free est disponible sur codemate pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.

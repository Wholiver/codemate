...
Codemate est livré avec deux sous-agents intégrés, **General** et **Explore**. Nous verrons cela ci-dessous.

---

## Agents intégrés

Codemate est livré avec deux agents primaires intégrés et deux sous-agents intégrés.

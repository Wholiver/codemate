...
Codemate comes with two built-in subagents, **General** and **Explore**. We'll look at this below.

---

## Built-in

Codemate comes with two built-in primary agents and two built-in subagents.

...
สร้าง `.codemate/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Codemate:
...
- ระดับผู้ใช้ (Global): `~/.config/codemate/commands/`
- ระดับโปรเจ็กต์: `.codemate/commands/`
...
Codemate มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)

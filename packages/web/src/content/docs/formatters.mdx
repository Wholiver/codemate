...
Codemate automatically formats files after they are written or edited using language-specific formatters. This ensures that the code that is generated follows the code styles of your project.
...
So if your project has `prettier` in your `package.json`, Codemate will automatically use it.

---

## How it works

When Codemate writes or edits a file, it:
...
You can customize formatters through the `formatter` section in your Codemate config.

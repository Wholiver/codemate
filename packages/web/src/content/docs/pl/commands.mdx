...
Utwórz `.codemate/commands/test.md`:
...
Możesz zdefiniować polecenia w `codemate.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji codemate:
...
- Globalnie: `~/.config/codemate/commands/`
- Na projekt: `.codemate/commands/`
...
codemate zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).

---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Codemate.
---
...
Codemate Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół Codemate.

:::note
Codemate Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w Codemate. Logujesz się do Codemate Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Codemate.
:::
...
Codemate Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

Codemate Zen działa jak każdy inny dostawca w Codemate.

1. Logujesz się do **<a href={console}>Codemate Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Codemate Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Codemate używa formatu
`codemate/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`codemate/gpt-5.5`.
...
- MiniMax M2.5 Free jest dostępny w Codemate przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ling 2.6 Flash Free jest dostępny w Codemate przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Hy3 Preview Flash Free jest dostępny w Codemate przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w Codemate przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w Codemate przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Codemate także dowolnego innego dostawcy.

---
title: Paylasim
description: codemate konusmalarini genel baglantilarla paylasin.
---

codemate'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda codemate:
...
codemate, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak codemate manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `codemate.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda codemate kullanimi icin [daha fazla bilgi alin](/docs/enterprise).

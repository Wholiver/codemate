...
description: codemate dile özgü biçimlendiriciler kullanır.
---

codemate, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

codemate, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, codemate bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

codemate bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri codemate yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.

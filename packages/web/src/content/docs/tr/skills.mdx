...
Ajan becerileri, codemate'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
codemate su konumlari tarar:

- Proje konfigurasyonu: `.codemate/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/codemate/skills/<name>/SKILL.md`
...
Proje yerel yollarinda codemate, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.codemate/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/codemate/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.codemate/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
codemate, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`codemate.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`codemate.json` icinde):

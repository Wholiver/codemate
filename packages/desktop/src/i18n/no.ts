export const dict = {
  ...
  "desktop.menu.help.documentation": "Codemate Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Codemate CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",

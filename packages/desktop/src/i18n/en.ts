export const dict = {
  ...
  "desktop.menu.help.documentation": "Codemate Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "Codemate CLI binary is missing. Try reinstalling the desktop app.",

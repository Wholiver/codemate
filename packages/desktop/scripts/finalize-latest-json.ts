...
const releaseId = process.env.CODEMATE_RELEASE
if (!releaseId) throw new Error("CODEMATE_RELEASE is required")

const version = process.env.CODEMATE_VERSION
if (!version) throw new Error("CODEMATE_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "codemate-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "codemate-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "codemate-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "codemate-desktop-linux-aarch64.rpm" },
  { key: "windows-aarch64-nsis", asset: "codemate-desktop-windows-arm64.exe" },
  { key: "windows-x86_64-nsis", asset: "codemate-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "codemate-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "codemate-desktop-darwin-aarch64.app.tar.gz",
  },
]

...
export const dict = {
  ...
  "notFound.title": "Bulunamadı | codemate",
  "notFound.heading": "404 - Sayfa bulunamadı",
  "notFound.home": "Ana sayfa",
  "notFound.docs": "Dokümantasyon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "codemate açık logo",
  "notFound.logoDarkAlt": "codemate koyu logo",
  ...
  "temp.feature.zen.beforeLink": "codemate tarafından sağlanan ",
  ...
  "temp.screenshot.caption": "codemate TUI ve tokyonight teması",
  "temp.screenshot.alt": "tokyonight temalı codemate TUI",
  "temp.logoLightAlt": "codemate açık logo",
  "temp.logoDarkAlt": "codemate koyu logo",
  ...
  "workspace.newUser.feature.lockin.body":
    "Zen'i herhangi bir kodlama ajanıyla kullanın ve istediğiniz zaman codemate ile diğer sağlayıcıları kullanmaya devam edin.",
  ...
  "workspace.newUser.step.login.after": "ve codemate seçeneğini seçin",
  "workspace.newUser.step.pasteKey": "API anahtarınızı yapıştırın",
  "workspace.newUser.step.models.before": "codemate'u başlatın ve çalıştırın",
  ...
  "workspace.keys.subtitle": "codemate hizmetlerine erişim için API anahtarlarınızı yönetin.",
  "workspace.keys.create": "API Anahtarı Oluştur",
  "workspace.keys.placeholder": "Anahtar adını girin",
  "workspace.keys.empty": "Bir codemate Gateway API anahtarı oluşturun",

...
import compareVideo from "../../asset/lander/codemate-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/codemate-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="codemate:auth" content={loggedin() ? "true" : "false"} />

...
import { and, Database, eq, isNull, lt, or, sql } from "@codemate-ai/console-core/drizzle/index.js"
import { KeyTable } from "@codemate-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@codemate-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@codemate-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@codemate-ai/console-core/util/date.js"
import { Identifier } from "@codemate-ai/console-core/identifier.js"
import { Billing } from "@codemate-ai/console-core/billing.js"
import { Actor } from "@codemate-ai/console-core/actor.js"
import { WorkspaceTable } from "@codemate-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@codemate-ai/console-core/model.js"
import { Subscription } from "@codemate-ai/console-core/subscription.js"
import { BlackData } from "@codemate-ai/console-core/black.js"
import { UserTable } from "@codemate-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@codemate-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@codemate-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@codemate-ai/console-core/lite.js"
import { Resource } from "@codemate-ai/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-codemate-session") ?? ""
    const requestId = input.request.headers.get("x-codemate-request") ?? ""
    const projectId = input.request.headers.get("x-codemate-project") ?? ""
    const ocClient = input.request.headers.get("x-codemate-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-codemate-request")
          headers.delete("x-codemate-session")
          headers.delete("x-codemate-project")
          headers.delete("x-codemate-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://codemate.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://codemate.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://codemate.ai/workspace/${authInfo.workspaceID}/members`

...
import desktopAppIcon from "../../asset/lander/codemate-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://codemate.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>codemate.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g codemate-ai")}>
                <code>
                  npm i -g <strong>codemate-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g codemate-ai")}>
                <code>
                  bun add -g <strong>codemate-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/codemate")}>
                <code>
                  brew install <strong>anomalyco/tap/codemate</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S codemate")}>
                <code>
                  paru -S <strong>codemate</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask codemate-desktop")}>
                <code>
                  brew install --cask <strong>codemate-desktop</strong>
                </code>
                <CopyStatus />
              </button>

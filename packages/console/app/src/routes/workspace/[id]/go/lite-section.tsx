...
import { Database, eq, and, isNull } from "@codemate-ai/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@codemate-ai/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#codemate-go")} target="_blank" rel="noopener noreferrer">

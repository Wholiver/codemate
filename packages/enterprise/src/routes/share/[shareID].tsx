import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@codemate-ai/sdk/v2"
import { SessionTurn } from "@codemate-ai/ui/session-turn"
import { SessionReview } from "@codemate-ai/ui/session-review"
import { DataProvider } from "@codemate-ai/ui/context"
import { FileComponentProvider } from "@codemate-ai/ui/context/file"
import { WorkerPoolProvider } from "@codemate-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@codemate-ai/ui/logo"
import { IconButton } from "@codemate-ai/ui/icon-button"
import { ProviderIcon } from "@codemate-ai/ui/provider-icon"
import { iife } from "@codemate-ai/core/util/iife"
import { Binary } from "@codemate-ai/core/util/binary"
import { NamedError } from "@codemate-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@codemate-ai/ui/tabs"
import { MessageNav } from "@codemate-ai/ui/message-nav"
import { FileSSR } from "@codemate-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@codemate-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/codemate-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/codemate"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://codemate.ai/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />

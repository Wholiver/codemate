...
Practical reference for the current tool-migration state in `packages/codemate`.
...
Tool tests should use the existing Effect helpers in `packages/codemate/test/lib/effect.ts`:

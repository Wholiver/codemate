...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/codemate.git")).toEqual({ owner: "sst", repo: "codemate" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/codemate")).toEqual({ owner: "sst", repo: "codemate" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/codemate.git")).toEqual({ owner: "sst", repo: "codemate" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/codemate")).toEqual({ owner: "sst", repo: "codemate" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/codemate.git")).toEqual({ owner: "sst", repo: "codemate" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/codemate")).toEqual({ owner: "sst", repo: "codemate" })
})

...
// test/preload.ts pins codemate_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.codemate_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.codemate_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.codemate_MODELS_PATH = undefined
  Flag.codemate_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.codemate_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.codemate_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})

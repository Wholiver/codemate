...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders codemate_CALLER", () => {
    process.env["codemate_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode codemate_CALLER", () => {
    process.env["codemate_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown codemate_CALLER", () => {
    process.env["codemate_CALLER"] = "unknown"

...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips codemate-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-codemate-directory"]).toBeUndefined()
      expect(forwarded["x-codemate-workspace"]).toBeUndefined()

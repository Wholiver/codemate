...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips codemate-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-codemate-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-codemate-directory")).toBeNull()
      expect(result.get("x-codemate-workspace")).toBeNull()

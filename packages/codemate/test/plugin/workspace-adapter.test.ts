...
const { Flag } = await import("@codemate-ai/core/flag/flag")
...
const experimental = Flag.codemate_EXPERIMENTAL_WORKSPACES
...
afterAll(() => {
  ...
  Flag.codemate_EXPERIMENTAL_WORKSPACES = experimental
})

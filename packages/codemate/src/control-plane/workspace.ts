...
export class Service extends Context.Service<Service, Interface>()("@codemate/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const startSync = Effect.fn("Workspace.startSync")(function* (space: Info) {
      if (!Flag.CODEMATE_EXPERIMENTAL_WORKSPACES) return
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        CODEMATE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        CODEMATE_WORKSPACE_ID: config.id,
        CODEMATE_EXPERIMENTAL_WORKSPACES: "true",

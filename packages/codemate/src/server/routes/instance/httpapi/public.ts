...
import { CodemateHttpApi } from "./api"
...
function fixSelfReferencingComponents(spec: OpenApiSpec) {
  ...
  const raw = OpenApi.fromApi(CodemateHttpApi) as unknown as OpenApiSpec
...
export const PublicApi = CodemateHttpApi.annotateMerge(
  OpenApi.annotations({
    title: "codemate",
    version: "1.0.0",
    description: "codemate api",

...
import { NonNegativeInt, type DeepMutable, withStatics } from "@codemate-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@codemate/File") {}

...
export class Service extends Context.Service<Service, Interface>()("@codemate/Image") {}
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.promise(async () => {
        try {
          ...
          ;(globalThis as typeof globalThis & { __codemate_PHOTON_WASM_PATH?: string }).__codemate_PHOTON_WASM_PATH =
            photonWasm

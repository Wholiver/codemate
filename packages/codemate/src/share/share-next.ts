import type * as SDK from "@codemate-ai/sdk/v2"
...
const disabled = process.env["CODEMATE_DISABLE_SHARE"] === "true" || process.env["CODEMATE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@codemate/ShareNext") {}

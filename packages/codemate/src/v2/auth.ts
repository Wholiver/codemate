...
import { Identifier } from "@codemate-ai/core/util/identifier"
...
export const OAUTH_DUMMY_KEY = "codemate-oauth-dummy-key"
...
export class Service extends Context.Service<Service, Interface>()("@codemate/v2/Auth") {}

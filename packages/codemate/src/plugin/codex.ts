import type { Hooks, PluginInput } from "@codemate-ai/plugin"
...
export async function CodexAuthPlugin(input: PluginInput): Promise<Hooks> {
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "codemate"
      output.headers["User-Agent"] = `codemate/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`

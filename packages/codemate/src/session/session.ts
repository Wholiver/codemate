import { Slug } from "@codemate-ai/core/util/slug"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".codemate", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@codemate/Session") {}
...
export const layer: Layer.Layer<Service, never, Bus.Service | Storage.Service | SyncEvent.Service> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const createNext = Effect.fn("Session.createNext")(function* (input: {
      ...
      if (!Flag.codemate_EXPERIMENTAL_WORKSPACES) {
...
function* listByProject(
  ...
  } else if (input.scope !== "project" && !Flag.codemate_EXPERIMENTAL_WORKSPACES) {
    if (input.directory) {

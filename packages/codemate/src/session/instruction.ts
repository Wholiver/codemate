...
const FILES = [
  "AGENTS.md",
  ...(Flag.CODEMATE_DISABLE_CLAUDE_CODE_PROMPT ? [] : ["CLAUDE.md"]),
...
export class Service extends Context.Service<Service, Interface>()("@codemate/Instruction") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const globalFiles = [
      ...
      ...(!Flag.CODEMATE_DISABLE_CLAUDE_CODE_PROMPT ? [path.join(global.home, ".claude", "CLAUDE.md")] : []),
    ]

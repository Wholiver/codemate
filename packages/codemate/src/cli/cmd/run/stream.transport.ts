...
import type { Event, GlobalEvent, codemateClient } from "@codemate-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@codemate/RunStreamTransport") {}

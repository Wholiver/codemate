...
//
// The saved variant persists across sessions in ~/.local/state/codemate/model.json
...
class Service extends Context.Service<Service, VariantService>()("@codemate/RunVariant") {}

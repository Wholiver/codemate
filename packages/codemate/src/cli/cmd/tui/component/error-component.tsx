...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/anomalyco/codemate/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("codemate-version", InstallationVersion)

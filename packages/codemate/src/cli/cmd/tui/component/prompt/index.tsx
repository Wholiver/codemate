...
import type { AssistantMessage, FilePart, UserMessage } from "@codemate-ai/sdk/v2"
...
import { useBindings, useCommandShortcut, useLeaderActive, usecodemateKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.codemate_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {

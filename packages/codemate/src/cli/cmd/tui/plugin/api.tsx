import type { TuiDialogSelectOption, TuiPluginApi, TuiRouteDefinition, TuiSlotProps } from "@codemate-ai/plugin/tui"
...
import type { usecodemateKeymap } from "../keymap"
...
type Input = {
  ...
  keymap: ReturnType<typeof usecodemateKeymap>

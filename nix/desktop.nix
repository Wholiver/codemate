...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  preBuild = ''
    ...
    cp ${codemate}/bin/codemate packages/desktop/src-tauri/sidecars/codemate-cli-${stdenv.hostPlatform.rust.rustcTarget}
  '';
  ...
  meta = {
    ...
    inherit (codemate.meta) platforms;
  };
})

...
- PR #13942: https://github.com/anomalyco/codemate/pull/13942

## Do Not Translate (Locale Additions)

- `codemate` (preserve casing in prose; keep `codemate` only when it is part of commands, package names, paths, or code)
- `codemate Zen`
- `codemate CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `codemate` in prose when referring to the product name; use `codemate`

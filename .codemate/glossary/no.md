...
- PR #10018: https://github.com/anomalyco/codemate/pull/10018
- PR #12935: https://github.com/anomalyco/codemate/pull/12935

## Do Not Translate (Locale Additions)

- `codemate` (preserve casing in prose; keep `codemate` only in commands, package names, paths, or code)
- `codemate CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`

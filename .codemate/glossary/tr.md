...
- PR #15835: https://github.com/anomalyco/codemate/pull/15835

## Do Not Translate (Locale Additions)

- `codemate` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `codemate` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `codemate` in prose, `codemate` only for exact technical identifiers
...
- Avoid changing `codemate` to `codemate` inside commands, URLs, package names, or code literals

...
# codemate Korean IME Fix Installer
# https://github.com/anomalyco/codemate/issues/14371
#
# Patches codemate to prevent Korean (and other CJK) IME last character
# truncation when pressing Enter in Kitty and other terminals.
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/claudianus/codemate/fix-zhipuai-coding-plan-thinking/patches/install-korean-ime-fix.sh | bash
...
echo "  curl -fsSL https://codemate.ai/install | bash"
echo ""

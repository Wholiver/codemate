...
Generates UPCOMING_CHANGELOG.md by running the codemate changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for codemate run (default: low)
      --quiet            Suppress codemate command output unless it fails

...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/codemate/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/codemate...\n")
...
console.log("Fetching npm all-time downloads for codemate-ai...\n")
const npmDownloads = await fetchNpmDownloads("codemate-ai")
